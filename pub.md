...
+ [J2] [**SEEP: Training Dynamics Grounds Latent Representation Search for Mitigating Backdoor Poisoning Attacks**](https://direct.mit.edu/tacl/article/doi/10.1162/tacl_a_00684/124258/SEEP-Training-Dynamics-Grounds-Latent)\
Xuanli He, Qiongkai Xu, Jun Wang, Benjamin I. P. Rubinstein, Trevor Cohn\
*<span style="color:gray">Transactions of the Association for Computational Linguistics (TACL), Sep 2024, presented in ACL'24</span>.*

+ [C27] [**WARDEN: Multi-Directional Backdoor Watermarks for Embedding-as-a-Service Copyright Protection**](https://aclanthology.org/2024.acl-long.725)\
...
+ [C26] [**Here's a Free Lunch: Sanitizing Backdoored Models with Model Merge**](https://aclanthology.org/2024.findings-acl.894)\
...
+ [C25] [**Backdoor Attacks on Multilingual Machine Translation**](https://aclanthology.org/2024.naacl-long.254)\
...
+ [W5] [**Attacks on Third-Party APIs of Large Language Models**](https://openreview.net/pdf?id=z48GQEpAqH)\
...
+ [C24] [**Security Challenges in Natural Language Processing Models**](https://aclanthology.org/2023.emnlp-tutorial.2/)\
...
+ [C23] [**Mitigating Backdoor Poisoning Attacks through the Lens of Spurious Correlation**](https://aclanthology.org/2023.emnlp-main.60/)\
Xuanli He, Qiongkai Xu, Jun Wang, Benjamin I. P. Rubinstein, Trevor Cohn\
...
+ [C21] [**Fingerprint Attack: Client De-Anonymization in Federated Learning**](https://arxiv.org/abs/2310.05960)\
...
+ [C18] [**Training-Free Lexical Backdoor Attacks on Language Models**](https://dl.acm.org/doi/abs/10.1145/3543507.3583348)\
...
### 2022
+ [C17] [**Extracted BERT Model Leaks More Information than You Think!**](https://aclanthology.org/2022.emnlp-main.99/)\
...
+ [C16] [**Variational Autoencoder with Disentanglement Priors for Low-Resource Task-Specific Natural Language Generation**](https://aclanthology.org/2022.emnlp-main.706/)\
Zhuang Li, Lizhen Qu, Qiongkai Xu, Tongtong Wu, Tianyang Zhan, Gholamreza Haffari\
*<span style="color:gray">In Proceedings of the 2022 Conference on Empirical Methods in Natural Language Processing (EMNLP), Dec 2022</span>.*


+ [C15] [**CATER: Intellectual Property Protection on Text Generation APIs via Conditional Watermarks**](https://openreview.net/forum?id=L7P3IvsoUXY)\
...
+ [C14] [**Student Surpasses Teacher: Imitation Attack for Black-Box NLP APIs**](https://aclanthology.org/2022.coling-1.251/)\
...
+ [C13] [**Protecting Intellectual Property of Language Generation APIs with Lexical Watermark**](https://arxiv.org/pdf/2112.02701.pdf)\
...
+ [C12] [**Model Extraction and Adversarial Transferability, Your BERT is Vulnerable!**](https://aclanthology.org/2021.naacl-main.161/)\
...
+ [C11] [**Privacy Monitoring Service for Conversations**](https://dl.acm.org/doi/abs/10.1145/3437963.3441706)\
...
### 2020
+ [C10] [**Personal Information Leakage Detection in Conversations**](https://www.aclweb.org/anthology/2020.emnlp-main.532.pdf)\
...
+ [C9] [**Adhering, Steering, and Queering: Treatment of Gender in Natural Language Generation**](https://dl.acm.org/doi/abs/10.1145/3313831.3376315)\
...
+ [J1] [**Raster Adaptive Optics for Video Rate Aberration Correction and Large FOV Multiphoton Imaging**](https://opg.optica.org/boe/fulltext.cfm?uri=boe-11-2-1032&id=426189)\
Yongxiao Li, Yean J Lim, Qiongkai Xu, Lynette Beattie, Elizabeth E Gardiner, Katharina Gaus, William R Heath, Woei Ming Lee\
*<span style="color:gray">Biomedical Optics Express, Feb 2020</span>.*

### 2019

+ [C8] [**ALTER: Auxiliary Text Rewriting Tool for Natural Language Generation**](https://aclanthology.org/D19-3003/)\
Qiongkai Xu, Chenchen Xu, Lizhen Qu\
...
+ [C7] [**Privacy-Aware Text Rewriting**](https://aclanthology.org/W19-8633.pdf)\
...
### 2018 and before
+ [W3] [**EPUTION at SemEval-2018 Task 2: Emoji Prediction with User Adaption**](https://aclanthology.org/S18-1071/)\
...
+ [C6] [**Attentive Graph-based Recursive Neural Network for Collective Vertex Classification**](https://dl.acm.org/doi/abs/10.1145/3132847.3133081)\
...
+ [C5] [**Demographic Inference on Twitter using Recursive Neural Networks**](https://aclanthology.org/P17-2075/)\
...
+ [W2] [**Unsupervised Pre-training With Sequence Reconstruction Loss for Deep Relation Extraction Models**](https://aclanthology.org/U16-1006.pdf)\
...
+ [C4] [**Semantic Documents Relatedness using Concept Graph Representation**](https://dl.acm.org/doi/abs/10.1145/2835776.2835801)\
...
+ [C3] [**Deep Neural networks for Learning Graph Representations**](https://ojs.aaai.org/index.php/AAAI/article/download/10179/10038)\
...
+ [W1] [**Detecting English-French Cognates Using Orthographic Edit Distance**](https://aclanthology.org/U15-1020.pdf)\
...
+ [C2] [**GraRep: Learning Graph Representations with Global Structural Information**](https://www.researchgate.net/profile/Qiongkai-Xu/publication/301417811_GraRep/links/5847ecdb08ae8e63e633b5f2/GraRep.pdf)\
Shaosheng Cao, Wei Lu, Qiongkai Xu\
...
+ [C1] [**Using Deep Linguistic Features for Finding Deceptive Opinion Spam**](https://aclanthology.org/C12-2131.pdf)\
